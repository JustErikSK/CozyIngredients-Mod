...
public class MilkBoxRecipe extends ShapelessRecipe {
    public MilkBoxRecipe(Identifier id, String group, ItemStack output, DefaultedList<Ingredient> ingredients) {
    ...
    public DefaultedList<ItemStack> getRemainder(CraftingInventory inventory) {
        ...
        for (int i = 0; i < inventory.size(); ++i) {
            ...
            if (item.isOf(Items.MILK_BUCKET)) {
