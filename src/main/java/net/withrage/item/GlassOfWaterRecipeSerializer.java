...
public class GlassOfWaterRecipeSerializer implements RecipeSerializer<GlassOfWaterRecipe> {
    public static final Identifier ID = new Identifier("cozyingredients", "glass_of_water");
